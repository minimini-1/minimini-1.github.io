...
<div class="d-flex flex-wrap gap-2 mb-4 justify-content-center">
  <a href="https://drive.google.com/file/d/1N5b4wav6pl_waFInv_nwY-GQsHBvEiLw/view?usp=drive_link" class="btn btn-outline-primary" target="_blank">
    <i class="fas fa-file-pdf"></i> CV (Updating, working on progress)
  </a>
  <a href="https://www.linkedin.com/in/jongmin-gim-664ab5315/?originalSubdomain=kr" class="btn btn-outline-primary" target="_blank">
    <i class="fab fa-linkedin"></i> LinkedIn
  </a>
  <a href="https://openreview.net/profile?id=~Jongmin_Gim1" class="btn btn-outline-primary" target="_blank">
